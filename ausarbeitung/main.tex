...
\usepackage
[backend=biber,style=apa,sorting=ynt]{biblatex}
...
\begin{document}
    ...
    polarisieren und die Bereitschaft, einer Position der Gegenseite inhaltlich zuzustimmen, nimmt ab.\footnote{\cite{BERTELSMANN}.}
    \par
