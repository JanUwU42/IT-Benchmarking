...
\begin{document}
    ...
    Die prototypische implementierung erfolgt anhan der theoretischen Grundlagen, die in dem vorherigen Kapitel beschrieben wurden.
    \newline
    Dabei wird ein Workflow in n8n erstellt, der die Erkennung von Fake News in Nachrichtenschlagzeilen mithilfe von ChatGPT- und Ollama-Agenten durchführt.
