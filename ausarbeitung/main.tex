...
\begin{document}
    ...
    sichtbar zu machen.\footnote{\cite{WirtschaftslexikonGabler}.} Im vorliegenden Use-Case werden ChatGPT und Ollama in n8n-Workflows
    eingebettet. So können sie mit Testdaten versorgt werden. Außerdem werden danach die Ergebnisse erfasst und anhand
    von ausgewählten Kennzahlen bewertet.

    Im Folgenden wird dabei zunächst ein theoretisches Verständnis geschaffen, bevor das Methodische Vorgehen des
